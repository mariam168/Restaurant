    ...
    <section className="py-24 px-6 bg-white">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-14 items-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          />
          <ServiceCard
            icon={<Truck className="text-green-700 w-6 h-6" />}
            title="Fast Delivery"
            desc="We deliver your order promptly to your door"
          />
          <ServiceCard
            icon={<ShoppingCart className="text-green-700 w-6 h-6" />}
            title="Online Ordering"
            desc="Explore menus & order with ease using our Online Ordering"
          />
          <ServiceCard
            icon={<Gift className="text-green-700 w-6 h-6" />}
            title="Gift Cards"
...
function ServiceCard({
  ...
  return (
    <div className="bg-white/70 backdrop-blur-lg hover:shadow-xl transition-all duration-300 rounded-xl p-6 space-y-4 border border-gray-200 hover:scale-105">
      <div className="bg-gradient-to-tr from-green-100 to-green-200 w-12 h-12 flex items-center justify-center rounded-full shadow-sm">
        {icon}
      </div>
